...
@extend_schema_view(
    ...
    post=extend_schema(summary="Create a new category", tags=["Categories"]),
)
...
@extend_schema_view(
    ...
    post=extend_schema(
        ...
        tags=["Models"],
        request=ModelWriteSerializer,
        responses={201: ModelReadSerializer}
    ),
)
...
@extend_schema_view(
    get=extend_schema(summary="Retrieve model details", tags=["Models"]),
    put=extend_schema(summary="Update a model", tags=["Models"], request=ModelWriteSerializer),
    patch=extend_schema(summary="Partial update a model", tags=["Models"], request=ModelWriteSerializer),
